 ...
 * 0069返回凭证转换代理
 */
public class SnfncPositiveSupply0069ResponseInterceptor implements Interceptable<SnfncPositiveResponseMessage> {
    /**
     * 持久化组件
     */
    ...
    public SnfncPositiveResponseMessage intercept(SnfncPositiveResponseMessage message) throws Exception {
        ...
        if (tvNode != null) { // 若节点不为空，则进行凭证转换
            // 得到对应付款的流水号
            String paySn = this.snfncPositivePersistence.querySerialNumber(tvNode.getText());
